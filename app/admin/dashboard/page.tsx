          ...
          return (
            <div key={stat.title} className="bg-card border border-border rounded-xl p-6">
              <div className="flex items-center justify-between">
                ...
                <div className={`p-3 rounded-lg ${stat.bgColor} dark:bg-secondary`}>
                  <Icon className={`w-6 h-6 ${stat.color} dark:text-foreground`} />
                </div>
              </div>
            </div>
          )
      ...
      <div className="bg-card border border-border rounded-xl p-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-2">
            ...
            <h2 className="text-xl font-semibold text-foreground">Recent Contact Submissions</h2>
          </div>
        ...
        {recentSubmissions.length > 0 ? (
          <div className="space-y-4">
            {recentSubmissions.map((submission) => (
              <div key={submission.id} className="border border-border rounded-lg p-4 hover:bg-secondary/50 transition-colors">
