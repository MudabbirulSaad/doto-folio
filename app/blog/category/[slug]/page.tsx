...
export default async function CategoryPage({ params, searchParams }: CategoryPageProps) {
  let categoryData: Awaited<ReturnType<ReturnType<typeof createServiceRolePublicBlogTaxonomyUseCases>['postsByCategory']>>
  let page: number
  let limit: number
  ...
  try {
    ...
    limit = Math.min(parseInt(resolvedSearchParams.limit || '12'), 50)
    categoryData = await createServiceRolePublicBlogTaxonomyUseCases().postsByCategory(resolvedParams.slug, {
      page,
      limit
    })
  } catch (error) {
