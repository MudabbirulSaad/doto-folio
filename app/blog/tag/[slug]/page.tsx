...
export default async function TagPage({ params, searchParams }: TagPageProps) {
  let tagData: Awaited<ReturnType<ReturnType<typeof createServiceRolePublicBlogTaxonomyUseCases>['postsByTag']>>
  let page: number
  let limit: number
  ...
  try {
    ...
    tagData = await createServiceRolePublicBlogTaxonomyUseCases().postsByTag(resolvedParams.slug, {
      page,
      limit
    })
  } catch (error) {
