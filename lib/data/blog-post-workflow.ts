import type { CreateBlogPostData, UpdateBlogPostData } from '@/lib/types/blog'
...
export class BlogPostWorkflowError extends Error {
  constructor(
    public code: 'VALIDATION_ERROR' | 'NOT_FOUND' | 'INTERNAL_ERROR',
    message: string,
